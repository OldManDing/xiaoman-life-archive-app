  ...
  return (
    <PageShell title="帮助与反馈" description="查看常见问题，并提交当前设备上的反馈记录。">
      <Panel>
        <div style={rowStyle}>
          <strong>常见问题</strong>
          <p style={helperTextStyle}>登录验证码可使用本地测试码；照片上传支持 JPG、PNG、WebP；家庭成员邀请会生成可分享的邀请码。</p>
...
const legalSections = [
  {
    ...
    items: [
      ...
      '用户应妥善保管手机号、验证码和设备，不得将账号借给他人使用，也不得上传侵权、违法、骚扰、广告或损害未成年人权益的内容。',
  ...
  },
  {
    title: '隐私政策',
    items: [
      '为提供成长档案服务，平台会处理手机号、昵称、孩子档案资料、家庭成员关系、成长记录、媒体文件、登录时间和必要审计日志。',
