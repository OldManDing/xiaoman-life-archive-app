...
const validationReasonMap: Array<[RegExp, string]> = [
  ...
  [/password must be shorter than or equal to 12 characters/i, '密码需为 8 到 12 位'],
  ...
  [/password_confirm must be shorter than or equal to 12 characters/i, '确认密码需为 8 到 12 位'],
